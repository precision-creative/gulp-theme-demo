const pushyLinks = document.querySelectorAll(".pushy a");
  ...
  function f() {
    a(t).addClass(v),
      a(t).on("click", function (b) {
        var c = a(this);
        c.hasClass(v)
          ? (c.siblings(t).addClass(v).removeClass(u),
            c.removeClass(v).addClass(u))
          : c.addClass(v).removeClass(u),
          b.stopPropagation();
      });
  }
  var g = a(".pushy"),
    ...
    m = "pushy-open-right",
    n = a(".site-overlay"),
    o = a(".pushy__hamburger, .pushy-link"),
    p = a(".pushy__hamburger"),
    q = a(g.data("focus")),
    r = 200,
    s = g.width() + "px",
    t = ".pushy-submenu",
...
// Custom code to close pushy on hash or external links
