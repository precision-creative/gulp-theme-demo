...
<div class="woocommerce-order">
	...
	?>
		...
		<?php if ($order->has_status('failed')) : ?>
			...
			<p class="woo-notice woo-notice--error woocommerce-thankyou-order-failed">
				<?php esc_html_e('Unfortunately your order cannot be processed as the originating bank/merchant has declined your transaction. Please attempt your purchase again.', 'woocommerce'); ?>
			</p>

			<p class="woo-notice woo-notice--error woocommerce-thankyou-order-failed-actions">
		...
		<?php else : ?>
			...
			<p class="woo-notice woo-notice--success woocommerce-thankyou-order-received">
			...
			<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
				...
				<?php if (is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $order->get_billing_email()) : ?>
					<li class="woocommerce-order-overview__email email">
						...
						<strong>
							<?php
							echo $order->get_billing_email(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							?>
						</strong>
					</li>
				<?php endif; ?>
